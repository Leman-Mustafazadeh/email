...
import temp4 from "../../../assets/images/templateBanner/temp4.png";
import { Input, QRCode, Space } from "antd";
import "./_style.scss";
const Template10 = () => {
  const [text, setText] = React.useState("https://ant.design/");
  return (
    <section className="template_dam9">
      <div className="container template_wrap9">
        <div className="row temp9_head">
          <div>
            <div className="row  flex-justify-space-between  template_hero9">
                ...
                <div>
                  ...
                  <div className="temp5_hero">
                    <div className="row flex-align-center">
                      ...
                      <a
                        href=""
                        className="font-size-16 font-weight-500 text-text pl-1 nunito"
                      >
            ...
            <div className="temp9_attend">
              <h1 className="font-size-22 font-weight-500 text-natural pb-1 nunito">
                Why to attend ?
              </h1>
              <p className="font-size-14 font-weight-400 text-natural nunito">
              ...
              <div className="temp9_button">
                <button className="font-size-14 font-weight-500 nunito bg-natural">
                  Join now
                </button>
              </div>
            </div>
