      ...
      <div className="">
        ...
        <div className="container">
          <div className="cookie_title">
            <h2 className="font-size-32 font-weight-700 text-text">
              Cookies Policy
            </h2>
            <p className="pb-5">
              **Last updated and effective date: [ Month ],
              {currentYear}**
            </p>
            <p>
              This Cookies Policy explains how emailsignaturegenerator.ai ("we,"
              "us," or "our") uses cookies and similar technologies to recognize
              you when you visit our website at emailsignaturegenerator.ai
            ...
            <div>
              ...
              <p>
                ...
                website recognize your device and remember information about
                your visit, such as your preferences and login details.
              </p>
            </div>
            ...
            <div className="scope">
              ...
              <p>
                - **Essential Cookies**: These are necessary for the operation
                of our website. They enable you to navigate the site and use its
                features.
              </p>
              <p>
                - **Performance Cookies**: These cookies help us understand how
                visitors interact with our website by collecting and reporting
                information anonymously. This helps us improve the functionality
                of our site.
              </p>

              <p>
                - **Functional Cookies**: These cookies allow our website to
                remember choices you make (such as your username and language
            ...
            <div className="scope">
              ...
              <p>
                - **Third-Party Cookies**: These are set by domains other than
                the one you are visiting, such as analytics or advertising
                services.
              </p>
            </div>
            ...
            <div className="scope">
              ...
              <p>- View cookies that are set on your device</p>

              <p>- Delete cookies </p>
              <p>- Block cookies</p>
              <p>
                - Receive a warning before a cookie is stored on your device
              </p>
              <p>
                For more information on how to manage cookies, visit the help
            ...
            <div className="scope">
              ...
              <p>
                ...
                technologies, please contact us at ___.
              </p>
            </div>
          </div>
        </div>
